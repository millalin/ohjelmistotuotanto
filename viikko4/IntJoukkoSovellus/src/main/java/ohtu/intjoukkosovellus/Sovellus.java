...
public class Sovellus {
    ...
    private static void yhdiste() {
        ...
        bJoukko = mikaJoukko();
        c = IntJoukko.kahdenJoukonYhdiste(aJoukko, bJoukko);
    ...
    private static void leikkaus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.kahdenJoukonLeikkaus(aJoukko, bJoukko);
    ...
    private static void erotus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.kahdenJoukonErotus(aJoukko, bJoukko);
    ...
    private static void kuuluu() {
        ...
        boolean kuuluuko = joukko.sisaltaa(kysLuku);
        if (kuuluuko) {
